...
syn keyword cStatement  pktype from
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
...
" Terra events
syn keyword cConstant RECEIVE REC_TEMP TEMP SEND SEND_DONE
syn keyword cConstant RISING FALLING DISABLE pIN pOUT SUCCESS ON OFF TOGGLE
syn keyword cConstant BROADCAST SEND_DATA_SIZE E_DIVZERO E_IDXOVF E_STKOVF 
syn keyword cConstant INIT LEDS LED0 LED1 LED2 REQ_TEMP REQ_PHOTO REQ_VOLTS
syn keyword cConstant SET_PORT_A SET_PORT_B CFG_PORT_A CFG_PORT_B REQ_PORT_A
syn keyword cConstant REQ_PORT_B CFG_INT_A CFG_INT_B REQ_CUSTOM_A REQ_MIC
